...
class Flowbite::Breadcrumb::ItemTest < Minitest::Test
  include ViewComponent::TestHelpers

  def test_render_component
    render_inline(Flowbite::Breadcrumb::Item.new(href: "/projects")) { "Projects" }
  ...
  def test_renders_with_custom_options
    render_inline(Flowbite::Breadcrumb::Item.new(href: "/projects", id: "projects-link", "data-action": "click->breadcrumb#navigate")) { "Projects" }
...
class Flowbite::Breadcrumb::Item::CurrentTest < Minitest::Test
  include ViewComponent::TestHelpers

  def test_render_component
    render_inline(Flowbite::Breadcrumb::Item::Current.new) { "Current Page" }
  ...
  def test_renders_with_custom_options
    render_inline(Flowbite::Breadcrumb::Item::Current.new(id: "current-page")) { "Current Page" }

    assert_selector("span[id='current-page']")
  end
end

class Flowbite::Breadcrumb::Item::FirstTest < Minitest::Test
  include ViewComponent::TestHelpers

  def test_render_component
    render_inline(Flowbite::Breadcrumb::Item::First.new(href: "/")) { "Home" }
  ...
  def test_renders_with_custom_options
    render_inline(Flowbite::Breadcrumb::Item::First.new(href: "/", id: "home-link")) { "Home" }
